...
//--------------------------------------------------------------------------------------------------
static uint8_t gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_ARR_LEN][CAN_EIM_VCU_CpuStats_DLC];
static uint8_t gVCU_PcbaVitals_TX_ARR[CANTX_EIM_VCU_PcbaVitals_ARR_LEN][CAN_EIM_VCU_PcbaVitals_DLC];
...
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M2_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_100Hz_AvgPeriod(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_100Hz_AvgPeriod(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_100Hz_AvgPeriod((uint32_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_100Hz_AvgPeriod(const float converted)
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M2_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_100Hz_AvgPeriod(converted, pData);
}
...
void CANTX_EIM_SetSRaw_VCU_100Hz_Load(const uint16_t rawVal)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_100Hz_Load(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_100Hz_Load(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_100Hz_Load((uint16_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_100Hz_Load(const float converted)
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M0_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_100Hz_Load(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M2_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_100Hz_MaxPeriod(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_100Hz_MaxPeriod(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_100Hz_MaxPeriod((uint32_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_100Hz_MaxPeriod(const float converted)
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M2_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_100Hz_MaxPeriod(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M2_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_100Hz_MinPeriod(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_100Hz_MinPeriod(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_100Hz_MinPeriod((uint32_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_100Hz_MinPeriod(const float converted)
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M2_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_100Hz_MinPeriod(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M3_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_10Hz_AvgPeriod(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_10Hz_AvgPeriod(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_10Hz_AvgPeriod((uint32_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_10Hz_AvgPeriod(const float converted)
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M3_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_10Hz_AvgPeriod(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M0_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_10Hz_Load(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_10Hz_Load(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_10Hz_Load((uint16_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_10Hz_Load(const float converted)
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M0_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_10Hz_Load(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M3_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_10Hz_MaxPeriod(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_10Hz_MaxPeriod(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_10Hz_MaxPeriod((uint32_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_10Hz_MaxPeriod(const float converted)
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M3_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_10Hz_MaxPeriod(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M3_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_10Hz_MinPeriod(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_10Hz_MinPeriod(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_10Hz_MinPeriod((uint32_t)rawVal, pData);
}
...
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M1_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_1kHz_AvgPeriod(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_1kHz_AvgPeriod(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_1kHz_AvgPeriod((uint32_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_1kHz_AvgPeriod(const float converted)
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M1_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_1kHz_AvgPeriod(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M0_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_1kHz_Load(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_1kHz_Load(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_1kHz_Load((uint16_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_1kHz_Load(const float converted)
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M0_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_1kHz_Load(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M1_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_1kHz_MaxPeriod(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_1kHz_MaxPeriod(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_1kHz_MaxPeriod((uint32_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_1kHz_MaxPeriod(const float converted)
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M1_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_1kHz_MaxPeriod(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M1_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_1kHz_MinPeriod(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_1kHz_MinPeriod(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_1kHz_MinPeriod((uint32_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_1kHz_MinPeriod(const float converted)
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M1_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_1kHz_MinPeriod(converted, pData);
}
...
void CANTX_EIM_SetSFromFrame_VCU_ADC_AvgPeriod(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_ADC_AvgPeriod((uint32_t)rawVal, pData);
}
...
void CANTX_EIM_SetSFromFrame_VCU_ADC_MaxPeriod(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_ADC_MaxPeriod((uint32_t)rawVal, pData);
}
...
void CANTX_EIM_SetSFromFrame_VCU_ADC_MinPeriod(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_ADC_MinPeriod((uint32_t)rawVal, pData);
}
...
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M0_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_CPU_Load(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_CPU_Load(const float converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_CPU_Load((uint16_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_CPU_Load(const float converted)
{
    uint8_t * const pData = &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M0_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_CPU_Load(converted, pData);
}
...
void CANTX_EIM_SetSRaw_VCU_PCBA_Aps1V(const uint16_t rawVal)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_Aps1V(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_PCBA_Aps1V(const float_q converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_Aps1V((uint16_t)rawVal, pData);
}
...
{
    uint8_t * const pData = &gVCU_PcbaVitals_TX_ARR[CANTX_EIM_VCU_PcbaVitals_M0_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_Aps2V(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_PCBA_Aps2V(const float_q converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_Aps2V((uint16_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_PCBA_Aps2V(const float_q converted)
{
    uint8_t * const pData = &gVCU_PcbaVitals_TX_ARR[CANTX_EIM_VCU_PcbaVitals_M0_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_PCBA_Aps2V(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_PcbaVitals_TX_ARR[CANTX_EIM_VCU_PcbaVitals_M0_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_BrakeSwitch(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_PCBA_BrakeSwitch(const uint32_t converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_BrakeSwitch((uint8_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_PCBA_BrakeSwitch(const uint32_t converted)
{
    uint8_t * const pData = &gVCU_PcbaVitals_TX_ARR[CANTX_EIM_VCU_PcbaVitals_M0_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_PCBA_BrakeSwitch(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_PcbaVitals_TX_ARR[CANTX_EIM_VCU_PcbaVitals_M0_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_DieTemp(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_PCBA_DieTemp(const int32_q converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_DieTemp((uint8_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_PCBA_DieTemp(const int32_q converted)
{
    uint8_t * const pData = &gVCU_PcbaVitals_TX_ARR[CANTX_EIM_VCU_PcbaVitals_M0_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_PCBA_DieTemp(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_PcbaVitals_TX_ARR[CANTX_EIM_VCU_PcbaVitals_M0_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_EngEnable(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_PCBA_EngEnable(const uint32_t converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_EngEnable((uint8_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_PCBA_EngEnable(const uint32_t converted)
{
    uint8_t * const pData = &gVCU_PcbaVitals_TX_ARR[CANTX_EIM_VCU_PcbaVitals_M0_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_PCBA_EngEnable(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_PcbaVitals_TX_ARR[CANTX_EIM_VCU_PcbaVitals_M0_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_EngStart(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_PCBA_EngStart(const uint32_t converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_EngStart((uint8_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_PCBA_EngStart(const uint32_t converted)
{
    uint8_t * const pData = &gVCU_PcbaVitals_TX_ARR[CANTX_EIM_VCU_PcbaVitals_M0_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_PCBA_EngStart(converted, pData);
}
...
{
    uint8_t * const pData = &gVCU_PcbaVitals_TX_ARR[CANTX_EIM_VCU_PcbaVitals_M0_ARR_IDX][0U];
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_UserSwitch(rawVal, pData);
}
void CANTX_EIM_SetSFromFrame_VCU_PCBA_UserSwitch(const uint32_t converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_PCBA_UserSwitch((uint8_t)rawVal, pData);
}
void CANTX_EIM_SetS_VCU_PCBA_UserSwitch(const uint32_t converted)
{
    uint8_t * const pData = &gVCU_PcbaVitals_TX_ARR[CANTX_EIM_VCU_PcbaVitals_M0_ARR_IDX][0U];
    CANTX_EIM_SetSFromFrame_VCU_PCBA_UserSwitch(converted, pData);
}
...
void CANTX_EIM_SetSFromFrame_VCU_PcbaVitalsMux(const uint32_t converted, uint8_t * const pData)
{
    ...
    CANTX_EIM_SetSRawFromFrame_VCU_PcbaVitalsMux((uint8_t)rawVal, pData);
}
...
bool CANTX_EIM_Init(void)
{
    ...
    CANTX_EIM_SetSFromFrame_VCU_CpuStatsMux(
        0U,
        &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M0_ARR_IDX][0U]
    );
    CANTX_EIM_SetSFromFrame_VCU_CpuStatsMux(
        1U,
        &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M1_ARR_IDX][0U]
    );
    CANTX_EIM_SetSFromFrame_VCU_CpuStatsMux(
        2U,
        &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M2_ARR_IDX][0U]
    );
    CANTX_EIM_SetSFromFrame_VCU_CpuStatsMux(
        3U,
        &gVCU_CpuStats_TX_ARR[CANTX_EIM_VCU_CpuStats_M3_ARR_IDX][0U]
    );
    CANTX_EIM_SetSFromFrame_VCU_CpuStatsMux(
        4U,
